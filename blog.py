...
def check_secure_val(secure_val):
    ...
    if secure_val == make_secure_val(val):
        return val
#Class for blog handler to handle the get, post, login  and logout methods
...
#Class for creating a post method.
class Post(db.Model):
    user_id = db.IntegerProperty(required=True)
...
#Class for main page of the blog.
...
#Class for post page which redirects to the page after posting in the blog
...
#Class for new post in the blog
...
#Class for creating validations of signup form
...
#Class for welcome page after user signup 
